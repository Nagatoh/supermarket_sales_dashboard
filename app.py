...
app.layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                html.Img(src='./assets/logo.png',height=50*2,width=30*3,style={"margin-left": "auto", "margin-right": "auto","margin-bottom":"20px", "display": "block"}),
                #html.H2("HCNF", style={"font-family": "fantasy", "font-size": "60px"}),
...
def render_graphs(city_list, main_variable):
    ...
    dft_income_time = df_filtered.groupby("Date")[main_variable].apply(
        operation).to_frame().reset_index()
    ...
    fig_income_date = px.bar(dft_income_time, x="Date",y=main_variable,)
